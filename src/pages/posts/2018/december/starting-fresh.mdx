...
changing all my old content from markdown to mdx.
...
had around my previous blog and just start fresh.
...
awesome work around the MDX language spec, `babel`, `prettier`, and even `eval`!
