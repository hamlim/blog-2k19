...
I recently picked up a Pixel Slate computer/tablet (I might write a short review for it but in the meantime check out this thread: [https://twitter.com/immatthamlin/status/1133865845854232577?s=20](https://twitter.com/immatthamlin/status/1133865845854232577?s=20)) and I wanted to see if I could configure my personal site, this site, so I could write a blog post, publish and deploy it all from my new computer. I also haven't setup the linux partition on the device yet either so I wanted to be able to do all of this from within Chrome.
