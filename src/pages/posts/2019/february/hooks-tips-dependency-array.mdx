...
publishDate: '02-06-2019'
---

# The Dependency Array

> This blog post is the first in what I expect to be a series on hooks, this blog post assumes you have a decent initial understanding of them. I highly suggest starting with the [ReactJS Docs](https://reactjs.org/docs/hooks-intro.html) on them first.
...
function App() {
  ...
  useEffect(() => {
    // Gets called on initial render, and everytime `count` changes
  }, [count])
  return null
}
```
