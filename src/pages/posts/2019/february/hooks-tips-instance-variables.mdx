...
publishDate: '02-22-2019'
---

import Footer from '@components/PostFooter.js'

# Migrating Instance Variables
...
Here is an example of a class based component that uses a few instance methods:
...
When migrating to Hooks, React offers the `useRef` hook, which is a convinient
...
scope**, and bias towards hook composition instead.
