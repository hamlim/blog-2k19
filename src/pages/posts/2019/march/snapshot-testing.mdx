...
import Footer from '@components/PostFooter.js'

# Snapshot Testing

The otherday I noticed this really succinct and to the point tweet about
...
the coolest things ever. It felt like I was adding code coverage to my
components, when in reality I was only testing the implementation details of my
components.

Over time I started to realize that the tests I was adding were only adding more
friction to the work I was doing. Since then I and my team have been slowly
removing snapshot tests from our tests whenever we make a change that makes the
tests fail.
